...
import MyTextComment from './MyTextComment'
import MyCheckboxA from './MyCheckboxA'
import MyCheckboxB from './MyCheckboxB'
import MyCheckboxC from './MyCheckboxC'
import MyCheckboxPass from './MyCheckboxPass'
import MyCheckboxNotPass from './MyCheckboxNotPass'
...
export default function MyList(props){
    ...
    const {items,setItems,mybearer,myreceiveemail,getscore,setGetScore} = React.useContext(DataContext) 
...
return (
   <div>
        ...
        <Typography variant="subtitle2"  style={{width:"58%"}}>{props.id} - {props.item}</Typography>
        <span style={{width:"34%"}}></span>
        <Typography variant="subtitle2"  style={{width:"1%"}}>{props.headscore}</Typography>
     </div>
 ...
 : <div style={{display:"flex",alignItems:"center"}}>
     ...
     <Typography variant='body1' style={{fontWeight: "bold",marginLeft: "10px"}}>LEED v4 for ID+C: Commercial Interiors</Typography>  
       ...
       {props.id === "7" ? 
            (<div>
                <ul className='Mylist'>
                    <li><Typography variant='caption'>Earn up to 4 of the 6 regional priority credits. Credits are determined by USGBC regional chapters.
                        </Typography>
                    </li>
                    <li><Typography variant='caption'>Priority credits & their geographic applicability on USGBC website: <a href="http://www.usgbc.org">http://www.usgbc.org</a>
                        </Typography>
                    </li>
                </ul>
            </div>) 
       ...
       {props.details.map((sub,index) => (       
          ...
          <div key={sub.info} style={{margin: "8px",display:"flex",justifyContent:"left",flexDirection: "row",flexWrap:"nowrap",alignItems:"center"}}>                 
                        ...
                        <label  onClick={(event)=>{handleClick(event,index)}} 
                                style={sub.option === "o" 
                                ? {width: "500px",marginLeft: "10px",cursor: props.id === "7" ? "default":"pointer"}
                                :{color: "red",width: "500px",marginLeft: "10px",cursor: props.id === "7" ? "default":"pointer"}}  >
                            <Typography >
                            
                                <Badge  overlap='rectangular'
                                    badgeContent={parseInt(sub.score)}   
                                    color={sub.score === sub.maxscore ? "primary" : "error"}>
                                    {props.id === "7" ? sub.infoscreen : sub.info    }
                                </Badge>
                            </Typography>
                        </label>
                        {props.id !== "7" ? 
                        ...
                        : null}
                        <Typography variant="subtitle2" style={{float: "right",paddingRight:"6px"}} >
                            <div>
                                <div style={{position:"relative",right:"0px",width:"10px"}}>
                                       {sub.maxscore === "0" 
                                       ? null 
                                       : sub.maxscore}
                                </div>
                        ...
                        {myreceiveemail !== "noone@dwp.com" 
                        ?  
                        
                        <React.Fragment>
                         <span style={sub.option == "o" ? {display:"flex",justifyContent:"center",alignItems:"center" ,background:"#e9ecf7"}
                                                       : {display:"flex",justifyContent:"center",alignItems:"center",background:"#e9ecf7" }}>
                            <span style={sub.option !== "o" 
                                ? {visibility:"hidden"}
                                :{visibility:"visible"}}>   

                                <MyCheckboxPass id={index+sub.info+"D"} 
                                    itemlist={sub.info} 
                                    name={sub.info+"D"} 
                                    parentid={sub.info} 
                                    holdparentid ={props.id} 
                                    value={sub.listcheckbox[3]} 
                                    myindex={index+"A"}/> 
                                
                                                    
                                <MyCheckboxNotPass id={index+sub.info+"E"} 
                                    itemlist={sub.info} 
                                    name={sub.info+"E"}
                                    parentid={sub.info} 
                                    holdparentid ={props.id} 
                                    value={sub.listcheckbox[4]} 
                                    myindex={index+"B"}   />
                            </span> 
                            ...
                            <MyTextReason
                                ...
                                holdparentid ={props.id} 
                                option={sub.option}
                                reasoncomment={sub.reasoncomment}
                                variant="outlined"
                                size="small"
                                style={{width: "300px",marginLeft:"10px",marginRight:"10px"}} 
                            />
